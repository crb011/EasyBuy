...
<script type="text/javascript" src="HTML/scripts/function-manage.js"></script>
	<script type="text/javascript">
		...
		{
			//传去servlet
			location.href="newsQuafy?page="+page;
		}
	</script>
</head>
<body>
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="newsQuafy">新闻</a></li>
		</ul>
	</div>
</div>
<div id="childNav">
		...
		<div class="manage">
			<table class="list">
				...
				<c:forEach items="${li}" var="i" varStatus="a">
					<tr>
						<td class="first w4 c">${i.en_id}</td>
						<td>${i.en_title}</td>
						<td class="w1 c"><a href="newsQuaID?en_id=${i.en_id}">修改</a>
						<a href="javascript:if(confirm('确定要删除吗？'))location='newsDel?en_id=${i.en_id}'">删除</a>
						</td>
					</tr>
				</c:forEach>
			</table>
			<div class="pager">
				<ul class="clearfix">
					当前: ${page} / ${maxpage} 页
					<a href="newsQuafy?page=1">首页</a>
					<a href="newsQuafy?page=${page-1}">上一页</a>
					<a href="newsQuafy?page=${page+1}">下一页</a>
					<a href="newsQuafy?page=${maxpage}">尾页</a>
