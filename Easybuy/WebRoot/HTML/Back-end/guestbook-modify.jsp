...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="guestbookUpd" method="post">
				<input type="hidden" name="ec_content" value="${li.ec_content}" />
				<input type="hidden" name="ec_create_time" value="${li.ec_create_time}" />
				<input type="hidden" name="ec_reply_time" value="<%=new Date(System.currentTimeMillis()).toString() %>" />
				<table class="form">
					<tr>
