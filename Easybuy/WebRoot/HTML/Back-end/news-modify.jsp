...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改新闻</h2>
		<div class="manage">
			<form action="newsUpd" method="post">
				<input type="hidden" name="id" value="${li.en_id}" />
				<input type="hidden" name="time" value="${li.en_create_time}" />
				<table class="form">
					<tr>
						<td class="field">新闻标题：</td>
						<td><input type="text" class="text" name="title" value="${li.en_title}" /></td>
					</tr>
					<tr>
						<td class="field">新闻内容：</td>
						<td><textarea name="content" name="en_content">${li.en_content}</textarea></td>
					</tr>
					<tr>
						<td></td>
