...
<div id="header" class="wrap">
	...
	<div class="help"><a href="shoppingQua" class="shopping">购物车</a><a href="guestbokSerFy">留言</a><a href="loginSer">登录</a><a href="registerSer">注册</a></div>
	<div class="navbar">
		<ul class="clearfix">
...
<div id="childNav">
	<div class="wrap">
		<ul class="clearfix">
			<li class="first"><a href="indexSer">音乐</a></li>
			<li><a href="#">影视</a></li>
			<li><a href="#">少儿</a></li>
			<li><a href="#">动漫</a></li>
			<li><a href="#">小说</a></li>
...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			...
			<form id="regForm" method="post" action="/Easybuy/registeSerZC" onsubmit="return checkForm(this);">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input class="text" type="text" name="userId" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="radio" value="F" name="sex" checked="checked"/>&nbsp;男
							&emsp;&emsp;<input type="radio" value="T" name="sex" />&nbsp;女
						<span></span></td>
					</tr>
						<td class="field">验证码：</td>
						<td><input class="text verycode" type="text" name="veryCode" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><img id="veryCode" src="/Easybuy/veryCodeSer" /><span></span></td>
					</tr>
					<tr>
						<td></td>
