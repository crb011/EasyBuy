...
<div id="header" class="wrap">
	...
	<div class="help"><a href="shoppingQua" class="shopping">购物车</a><a href="loginSer">登录</a><a href="registerSer">注册</a><a href="guestbokSerFy">留言</a></div>
	<div class="navbar">
		<ul class="clearfix">
		...
		<div class="box">
			...
			<div class="msg">
				...
				<script type="text/javascript">
					setTimeout("location.href='indexSer'", 3000);
				</script>
			</div>
		</div>
	</div>
